    ...
    <div className="bg-white overflow-x-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-8">
              At its core, recruitment is a deeply human endeavor. It's about
              connecting ambition with opportunity, and vision with the precise
              talent that can bring it to life. Novotion was founded on this
      ...
      <section ref={setRef("overview")} className="py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            <div
              className={`w-full lg:w-[30%] relative transform transition-all duration-1000 delay-200 ${
                isVisible.overview
            ...
            <div
              className={`w-full lg:w-[70%] transform transition-all duration-1000 delay-400 ${
                isVisible.overview
                  ? "translate-x-0 opacity-100"
                  : "translate-x-10 opacity-0"
              }`}
                ...
                <div className="space-y-6 text-gray-600 text-base sm:text-lg leading-relaxed">
                  <div className="relative pl-4 sm:pl-6 border-l-4 border-blue-500 bg-blue-50/50 rounded-r-2xl p-4 sm:p-6">
                    <p className="text-sm sm:text-base">
                      We are a specialized Recruitment Process Outsourcing (RPO)
                      and Career Support Services company, but we see ourselves
                      as something more: we are architects of opportunity. For
                      our organizational clients in the UK and USA, we build the
                      high-performing teams that drive sustainable growth. For
                      the skilled professionals we support, we pave the way for
                  ...
                  <div className="relative pl-4 sm:pl-6 border-l-4 border-blue-600 bg-blue-50/30 rounded-r-2xl p-4 sm:p-6">
                    <p className="text-sm sm:text-base">
                      Founded in 2021, Novotion operates with a global
                      footprint—with strategic centers in India, the USA, and
                      the UK. This structure allows us to blend deep local
                      market expertise with the 24/7 operational power of a
                      global team. Our goal isn't just to fill a position or
                      find a job; it's to empower businesses and professionals
                      to achieve their absolute full potential.
                    </p>
                  </div>

                  <div className="relative pl-4 sm:pl-6 border-l-4 border-blue-700 bg-blue-50/10 rounded-r-2xl p-4 sm:p-6">
                    <p className="text-sm sm:text-base">
                      This dual approach enables deep expertise in both
                      corporate recruitment and IT staffing delivering precise
                      matches, stronger partnerships, and long-term success for
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <div
              className={`w-full lg:w-[70%] transform transition-all duration-1000 delay-200 ${
                isVisible.solutions
                  ? "translate-x-0 opacity-100"
                  : "-translate-x-10 opacity-0"
              }`}
            >
              ...
              {/* Dropdown Content */}
              <div className="space-y-2 sm:space-y-3 text-blue-100 leading-relaxed mb-6 sm:mb-8">
                {/* Dropdown Item 1 */}
                <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
                  <button
                    className="w-full text-left p-2 sm:p-2 lg:p-2 flex justify-between items-center hover:bg-white/5 transition-colors duration-300"
                    onClick={() =>
                      setIsVisible((prev) => ({
                        ...prev,
                        dropdown1: !prev.dropdown1,
                      }))
                    }
                  >
                    <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                      Guidance That's Personal
                    </h3>
                    <svg
                      className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${
                        isVisible.dropdown1 ? "rotate-180" : ""
                      }`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                  ...
                  <div
                    className={`px-4 sm:px-5 lg:px-6 transition-all duration-300 overflow-hidden ${
                      isVisible.dropdown1
                        ? "pb-2 sm:pb-2 lg:pb-2 max-h-32"
                        : "max-h-0"
                    }`}
                  >
                    <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
                      You're not a number on a spreadsheet. You get dedicated
                      consultants who know your name, understand your industry,
                      and are invested in your specific goals.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
                  <button
                    ...
                    onClick={() =>
                      setIsVisible((prev) => ({
                        ...prev,
                        dropdown2: !prev.dropdown2,
                      }))
                    }
                  >
                    <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                      Expertise That's Deep
                    </h3>
                    <svg
                      className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${
                        isVisible.dropdown2 ? "rotate-180" : ""
                      }`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                  ...
                  >
                    <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
                      Our teams are specialized across 15+ industries and
                      countless job functions. We speak your language and
                      understand the nuances of your market.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
                  <button
                    ...
                    onClick={() =>
                      setIsVisible((prev) => ({
                        ...prev,
                        dropdown3: !prev.dropdown3,
                      }))
                    }
                  >
                    <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                      A Process That's Transparent
                    </h3>
                    <svg
                      className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${
                        isVisible.dropdown3 ? "rotate-180" : ""
                      }`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                  ...
                  >
                    <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
                      We believe in complete visibility. You'll receive
                      measurable outcomes and clear communication at every step
                      of the process.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
                  <button
                    ...
                    onClick={() =>
                      setIsVisible((prev) => ({
                        ...prev,
                        dropdown4: !prev.dropdown4,
                      }))
                    }
                  >
                    <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                      Support That's End-to-End
                    </h3>
                    <svg
                      className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${
                        isVisible.dropdown4 ? "rotate-180" : ""
                      }`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                  ...
                  >
                    <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
                      From the first resume draft to long-term post-placement
                      support, we are your partners for the entire journey.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
                  ...
                  >
                    ...
                    <svg
                      className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${
                        isVisible.dropdown5 ? "rotate-180" : ""
                      }`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                  ...
                  >
                    <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
                      Our global reach and 24/7 support model mean we are
                      working for you around the clock, ensuring no opportunity
                      is missed.
                    </p>
                  </div>
                </div>
              ...
              {/* Channel Icons - Updated with responsive text */}
              <div className="grid grid-cols-2 sm:grid-cols-6 gap-2 sm:gap-2 mb-0">
                {[
                  ...
                  <div
                    key={channel.name}
                    className="group relative bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4 shadow-lg hover:shadow-xl transform hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-300 overflow-hidden border border-white/20"
                  >
                    ...
                    <div className="relative text-center">
                      <div className="text-base sm:text-lg lg:text-xl mb-1 transform group-hover:scale-105 sm:group-hover:scale-110 transition-transform duration-300">
                        {channel.icon}
                      </div>
                      <div className="text-blue-200 group-hover:text-white font-semibold text-xs sm:text-sm transition-colors duration-300 leading-tight">
                        {channel.name}
                      </div>
                    </div>
                  </div>
            ...
            {/* Image Column - 40% width - Updated with responsive sizes */}
            <div
              className={`w-full lg:w-[30%] transform transition-all duration-1000 delay-400 ${
                isVisible.solutions
                  ? "translate-x-0 opacity-100"
                  : "translate-x-10 opacity-0"
              }`}
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
                  <div className="space-y-2 sm:space-y-3 lg:space-y-4">
                    <div className="group rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-blue-900 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                    ...
                    <div className="group rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-blue-800 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                        <p className="text-white font-semibold text-xs sm:text-sm">
                  ...
                  <div className="space-y-2 sm:space-y-3 lg:space-y-4 pt-6 sm:pt-8 lg:pt-12 xl:pt-16">
                    <div className="group rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                      <img
                        ...
                        className="w-full h-28 sm:h-32 lg:h-40 xl:h-48 object-cover"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-blue-700 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                        <p className="text-white font-semibold text-xs sm:text-sm">
                    ...
                    <div className="group rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                      <img
                        ...
                        className="w-full h-32 sm:h-40 lg:h-48 xl:h-56 object-cover"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-blue-600 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                        <p className="text-white font-semibold text-xs sm:text-sm">
                          Global Operations
                        </p>
                      </div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold mb-3 sm:mb-4 text-gray-900">
              Industries We <span className="text-blue-800">Serve</span>
            </h2>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 mx-auto leading-relaxed max-w-2xl">
              With expertise spanning 15+ industry verticals, we deliver
              specialized recruitment solutions that understand the unique
              demands and skill requirements of each sector.
            </p>
          </div>

          <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-2 sm:gap-3 lg:gap-4">
            {industries.map((industry, idx) => (
              <div
                key={industry.name}
                className={`group relative bg-white rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-4 lg:p-5 xl:p-6 shadow-md hover:shadow-xl transform hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-300 border border-gray-100 overflow-hidden min-h-[100px] sm:min-h-[120px] lg:min-h-[140px] xl:min-h-[160px] flex items-center justify-center ${
                  isVisible.industries
                    ? "translate-y-0 opacity-100"
                    : "translate-y-10 opacity-0"
                }`}
              ...
              >
                ...
                <div className="relative z-10 text-center group-hover:opacity-0 group-hover:scale-90 transition-all duration-300">
                  <div className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl mb-2 sm:mb-3 lg:mb-4">
                    {industry.icon}
                  </div>
                  <h3 className="font-bold text-gray-800 text-xs sm:text-sm lg:text-base xl:text-lg leading-tight">
                    {industry.name}
                  </h3>
                </div>

                {/* Hover State - Description Only */}
                <div className="absolute inset-0 flex items-center justify-center p-2 sm:p-3 lg:p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <p className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed text-center">
                    Specialized recruitment solutions for {industry.name} sector
                  </p>
                </div>

                <div
                  className={`absolute bottom-0 left-0 w-full h-0.5 sm:h-1 bg-gradient-to-r ${industry.color} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300`}
                ></div>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-blue-100 mx-auto">
              These aren't just words on a wall; they are the principles that
              guide every decision, every partnership, and every placement we
              make.
            </p>
          </div>
      ...
      <section ref={setRef("vision")} className="py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed text-center lg:text-left">
                To redefine how recruitment and placement services operate by
                providing personalized, transparent, and value-driven solutions
                that enhance both employability and organizational growth.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed text-center lg:text-left">
                To be the most trusted partner in career and talent development,
                known not just for our results, but for our integrity and our
                unwavering commitment to the success of every client and
                candidate.
              </p>
            </div>
          </div>
          ...
          {/* Simple Links Section (Using <a> tags) */}
          <div className="mt-12 lg:mt-16 border-t border-gray-200 pt-8">
           
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 text-lg font-medium">
              {/* Privacy Policy Link */}
              <a
                href="/privacy"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-blue-100 mb-8 leading-relaxed">
              Join 500+ organizations and 10,000+ professionals who trust
              Novotion for their recruitment and career success.
            </p>
