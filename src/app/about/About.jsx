        ...
        <div className="space-y-2 sm:space-y-3 text-blue-100 leading-relaxed mb-6 sm:mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
            <button 
              ...
              onClick={() => setIsVisible(prev => ({...prev, dropdown1: !prev.dropdown1}))}
            >
              <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                Guidance That's Personal
              </h3>
              <svg 
                className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${isVisible.dropdown1 ? 'rotate-180' : ''}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
            ...
            <div className={`px-4 sm:px-5 lg:px-6 transition-all duration-300 overflow-hidden ${isVisible.dropdown1 ? 'pb-2 sm:pb-2 lg:pb-2 max-h-32' : 'max-h-0'}`}>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
            <button 
              className="w-full text-left p-2 sm:p-2 lg:p-2 flex justify-between items-center hover:bg-white/5 transition-colors duration-300"
              onClick={() => setIsVisible(prev => ({...prev, dropdown2: !prev.dropdown2}))}
            >
              <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                Expertise That's Deep
              </h3>
              <svg 
                className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${isVisible.dropdown2 ? 'rotate-180' : ''}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
            ...
            <div className={`px-4 sm:px-5 lg:px-6 transition-all duration-300 overflow-hidden ${isVisible.dropdown2 ? 'pb-2 sm:pb-2 lg:pb-2 max-h-32' : 'max-h-0'}`}>
              <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
            <button 
              className="w-full text-left p-2 sm:p-2 lg:p-2 flex justify-between items-center hover:bg-white/5 transition-colors duration-300"
              onClick={() => setIsVisible(prev => ({...prev, dropdown3: !prev.dropdown3}))}
            >
              <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                A Process That's Transparent
              </h3>
              <svg 
                className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${isVisible.dropdown3 ? 'rotate-180' : ''}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
            ...
            <div className={`px-4 sm:px-5 lg:px-6 transition-all duration-300 overflow-hidden ${isVisible.dropdown3 ? 'pb-2 sm:pb-2 lg:pb-2 max-h-32' : 'max-h-0'}`}>
              <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
            <button 
              className="w-full text-left p-2 sm:p-2 lg:p-2 flex justify-between items-center hover:bg-white/5 transition-colors duration-300"
              onClick={() => setIsVisible(prev => ({...prev, dropdown4: !prev.dropdown4}))}
            >
              <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                Support That's End-to-End
              </h3>
              <svg 
                className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${isVisible.dropdown4 ? 'rotate-180' : ''}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
            ...
            <div className={`px-4 sm:px-5 lg:px-6 transition-all duration-300 overflow-hidden ${isVisible.dropdown4 ? 'pb-2 sm:pb-2 lg:pb-2 max-h-32' : 'max-h-0'}`}>
              <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 overflow-hidden">
            <button 
              className="w-full text-left p-2 sm:p-2 lg:p-2 flex justify-between items-center hover:bg-white/5 transition-colors duration-300"
              onClick={() => setIsVisible(prev => ({...prev, dropdown5: !prev.dropdown5}))}
            >
              <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-white pr-2">
                A Team That's Always On
              </h3>
              <svg 
                className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-300 transform transition-transform duration-300 flex-shrink-0 ${isVisible.dropdown5 ? 'rotate-180' : ''}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
            ...
            <div className={`px-4 sm:px-5 lg:px-6 transition-all duration-300 overflow-hidden ${isVisible.dropdown5 ? 'pb-2 sm:pb-2 lg:pb-2 max-h-32' : 'max-h-0'}`}>
              <p className="text-blue-100 text-xs sm:text-sm lg:text-base">
            ...
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              <div className="group rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-blue-900 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                  <p className="text-white font-semibold text-xs sm:text-sm">Team Collaboration</p>
                </div>
              </div>
              <div className="group rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                <img 
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-blue-800 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                  <p className="text-white font-semibold text-xs sm:text-sm">Candidate Interviews</p>
                </div>
              </div>
            </div>
            <div className="space-y-2 sm:space-y-3 lg:space-y-4 pt-6 sm:pt-8 lg:pt-12 xl:pt-16">
              <div className="group rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-blue-700 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                  <p className="text-white font-semibold text-xs sm:text-sm">Professional Training</p>
                </div>
              </div>
              <div className="group rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                <img 
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-blue-600 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-3 sm:p-4">
                  <p className="text-white font-semibold text-xs sm:text-sm">Global Operations</p>
                </div>
              </div>
            </div>
          </div>
...
<section ref={setRef('industries')} className="py-12 sm:py-16 lg:py-20 bg-slate-50">
  <div className="container mx-auto px-4 sm:px-6 lg:px-8">
    <div className={`text-center mb-8 sm:mb-12 lg:mb-16 transform transition-all duration-1000 ${isVisible.industries ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
    ...
    <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-2 sm:gap-3 lg:gap-4">
      {industries.map((industry, idx) => (
        ...
        >
          ...
          <div className={`absolute bottom-0 left-0 w-full h-0.5 sm:h-1 bg-gradient-to-r ${industry.color} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300`}></div>
        </div>
      ))}
    </div>
  </div>
