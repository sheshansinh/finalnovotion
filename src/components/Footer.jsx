...
const NovotionFooter = () => {
  ...
  const footerLinks = {
    ...
    legal: [
      ...
      { label: "Cancellation and Refund Policy", href: "/cancellation-and-refund" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed mb-6 text-sm md:text-base">
              ...
              and Career Support Services for IT professionals. With 500+
              clients and 10,000+ successful placements across 15+ industries,
              we deliver transparent, results-driven hiring solutions.
            </p>
