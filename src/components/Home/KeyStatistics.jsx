...
const KeyStatistics = () => {
  ...
  return (
    <div className="light-section text-black relative w-full py-12 md:py-20 bg-white text-gray-900 overflow-hidden min-h-screen-md flex items-center">
      {/* Background patterns */}
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          {/* UPDATED Statistics Grid - Changed to lg:grid-cols-4 for 8 cards */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:gap-7 lg:gap-10 max-w-7xl mx-auto">
