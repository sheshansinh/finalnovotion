...
// Updated company logos based on your requirements
const companyLogos = [
  ...
  { name: "Sarasota County Government", url: "/placeholder-government-logo.svg" }, // You'll need to replace this with actual logo
];
    ...
    <div className="light-section text-black relative w-full py-12 md:py-24 bg-white text-gray-900 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg md:text-xl lg:text-2xl text-gray-700 mb-6 md:mb-8 max-w-3xl mx-auto"
          >
          ...
          {/* Additional organizations count */}
          <motion.div
            variants={itemVariants}
            className="mt-6 md:mt-8 text-gray-600 text-sm md:text-base"
          >
